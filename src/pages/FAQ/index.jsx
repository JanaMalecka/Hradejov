...
const FAQ = () => {
  return (
    <div className="container">
      ...
      <h3 className="heading--small"> Co si připravit s sebou?</h3>
      <p>
        Postačí vám naše kniha s návodem ke hře a tužka na zapsání odpovědí.
      </p>
      <h3 className="heading--small">Jak hra probíhá?</h3>
      <p>
      ...
      <h3 className="heading--small">Odměna pro děti?</h3>
      <p>
        ...
        zašleme poštou. V případě zájmu o více výhor nás kontaktujte na témže
        emailu.
      </p>
      <h3 className="heading--small">Jak dlouho trvá hra?</h3>
      <p>
